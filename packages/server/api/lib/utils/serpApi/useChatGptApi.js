...
async function createQuotesChatGptBasedOnQuery(query) {
  // Generate a short description using OpenAI

  const prompt = `Create 10 quotes based on this query ${query} in this format [
...
module.exports = createQuotesChatGptBasedOnQuery;
